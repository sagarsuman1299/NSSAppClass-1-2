...
public class Indian_currency : MonoBehaviour
{
    ////////////// Variables ////////////////////
    /////////////////////////////////////////////
    ...
    public void Startfn()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            Question_space[i].GetComponent<Image>().sprite = Other_curren[t];
        }
        ...
        Answer_index = Random.Range(0, 12);

        Question_space[Correct_index].GetComponent<Image>().sprite = Indian_curren[Answer_index];
    }
